 ...
 * @example
 * ```ts
 * import { AnvilStartupError, spawnAnvil } from "@iris-credit/test";
 *
 ...
 * @example
 * ```ts
 * import { AnvilProcessError, spawnAnvil } from "@iris-credit/test";
 *
 ...
 * @example
 * ```ts
 * import { AnvilCleanupError, spawnAnvil } from "@iris-credit/test";
 *
 * const anvil = await spawnAnvil({ chainId: 1 });
 * try {
 *   await anvil.stopAndWait();
