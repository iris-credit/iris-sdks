...
/** Aave V3 `IAaveOracle` interface ABI — the pool's price oracle, quoting in base currency. */
...
/** Aave V3 `IAToken` interface ABI — the interest-bearing supply token. */
export const aaveV3ATokenAbi = [
  {
    type: "function",
...
/** Aave V3 `IVariableDebtToken` interface ABI — the variable debt token. */
export const aaveV3VariableDebtTokenAbi = [
  {
    type: "function",
    name: "UNDERLYING_ASSET_ADDRESS",
    inputs: [],
