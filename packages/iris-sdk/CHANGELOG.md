...
- [#142](https://github.com/iris-credit/iris-sdks/pull/142) [`89bb10b`](https://github.com/iris-credit/iris-sdks/commit/89bb10b00166ff65ecd41dc8162b3899f9be95c5) Thanks [@madiha-right](https://github.com/madiha-right)! - Expose the EIP-712 payload of every signature `Requirement` as `action.typedData`, so integrators can inspect or display the exact typed data before it is signed by the built-in `Requirement.sign(client, userAddress)`.
