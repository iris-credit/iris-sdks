...
<a href="https://www.npmjs.com/package/@iris-credit/iris-ts">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/npm/v/@iris-credit/iris-ts?colorA=21262d&colorB=21262d&style=flat">
        <img src="https://img.shields.io/npm/v/@iris-credit/iris-ts?colorA=f6f8fa&colorB=f6f8fa&style=flat" alt="Version">
    </picture>
</a>
<a href="https://github.com/iris-credit/iris-sdks/blob/main/packages/iris-ts/LICENSE">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/npm/l/@iris-credit/iris-ts?colorA=21262d&colorB=21262d&style=flat">
        <img src="https://img.shields.io/npm/l/@iris-credit/iris-ts?colorA=f6f8fa&colorB=f6f8fa&style=flat" alt="MIT License">
    </picture>
</a>
<a href="https://www.npmjs.com/package/@iris-credit/iris-ts">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/npm/dm/@iris-credit/iris-ts?colorA=21262d&colorB=21262d&style=flat">
        <img src="https://img.shields.io/npm/dm/@iris-credit/iris-ts?colorA=f6f8fa&colorB=f6f8fa&style=flat" alt="Downloads per month">
    </picture>
</a>
<br />
<br />
...
```bash
npm install @iris-credit/iris-ts
```

```bash
yarn add @iris-credit/iris-ts
```
...
The return value will retain the nullability of the input value (giving priority to `value` over `decimals` for bigints, if none is defined), unless a `.default()` method is applied (refer to [Number Formatter](#number-formatter) for details).

> [!Tip]
> You can store the partially populated formatter as a custom formatter:
>
> ```typescript
> import { format } from "@iris-credit/iris-ts";
>
...
```typescript
import { createFormat } from "@iris-credit/iris-ts";
