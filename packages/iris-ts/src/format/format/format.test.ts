...
describe("format", () => {
  ...
  describe(Format.hex, () => {
    ...
    describe("should properly format bigint in hex format", () => {
      ...
      test("with a default value", () => {
        expect(format.hex.default("default").of(undefined, 18)).toEqual("default");
        expect(format.hex.default("default").of(null, 18)).toEqual("default");
        expect(format.hex.default("default").of(bigint, undefined)).toEqual("default");
        expect(format.hex.default("default").of(bigint, null)).toEqual("default");
      });
  ...
  describe("number", () => {
    ...
    describe("should properly format number in number format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.number.unit("$").sign().of(number)).toEqual("+$12345.6789");
        expect(format.number.unit("$").sign().of(-number)).toEqual("-$12345.6789");
      });

      test("without trailing zeros", () => {
        expect(format.number.digits(6).of(number)).toEqual("12345.678900");
        expect(format.number.digits(6).trailingZero(false).of(number)).toEqual("12345.6789");
        expect(format.number.digits(6).trailingZero(true).of(number)).toEqual("12345.678900");
      });
      ...
      test("with really small numbers", () => {
        expect(format.number.of(1.23e-30)).toEqual("0.00000000000000000000000000000123");
        expect(format.number.of(0.99e-12)).toEqual("0.00000000000099");
      });

      test("with really big numbers", () => {
        expect(format.number.of(1e30)).toEqual("1000000000000000000000000000000");
        expect(format.number.of(1.234e30)).toEqual("1234000000000000000000000000000");
        expect(format.number.of(1.234e2)).toEqual("123.4");
      });

      test("with a default value", () => {
        expect(format.number.default("default").of(undefined)).toEqual("default");
    ...
    describe("should properly format bigint in number format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.number.unit("$").sign().of(bigint, decimals)).toEqual("+$12345.6789");
        expect(format.number.unit("$").sign().of(-bigint, decimals)).toEqual("-$12345.6789");
      });
      ...
      test("with a default value", () => {
        expect(format.number.default("default").of(undefined, 18)).toEqual("default");
        expect(format.number.default("default").of(null, 18)).toEqual("default");
        expect(format.number.default("default").of(bigint, undefined)).toEqual("default");
        expect(format.number.default("default").of(bigint, null)).toEqual("default");
      });
  ...
  describe("short", () => {
    describe("should properly format number in short format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.short.unit("\u20ac").sign().of(number)).toEqual("+12.3456789k \u20ac");
        expect(format.short.unit("\u20ac").sign().of(-number)).toEqual("-12.3456789k \u20ac");
      });

      test("without trailing zeros", () => {
        expect(format.short.digits(8).of(number)).toEqual("12.34567890k");
        expect(format.short.digits(8).trailingZero(false).of(number)).toEqual("12.3456789k");
        expect(format.short.digits(8).trailingZero(true).of(number)).toEqual("12.34567890k");
      });
      ...
      test("with a default value", () => {
        expect(format.short.default("default").of(undefined)).toEqual("default");
    ...
    describe("should properly format bigint in short format", () => {
      ...
      test("with small numbers with commas", () => {
        expect(format.short.smallValuesWithCommas().of(bigint, decimals + 1)).toEqual(
          "1,234.56789",
        );
      });
      ...
      test("with a default value", () => {
        expect(format.short.default("default").of(undefined, 18)).toEqual("default");
        expect(format.short.default("default").of(null, 18)).toEqual("default");
        expect(format.short.default("default").of(bigint, undefined)).toEqual("default");
        expect(format.short.default("default").of(bigint, null)).toEqual("default");
      });
  ...
  describe("commas", () => {
    describe("should properly format number in commas format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.commas.unit("ETH").sign().of(number)).toEqual("+12,345.6789 ETH");
        expect(format.commas.unit("ETH").sign().of(-number)).toEqual("-12,345.6789 ETH");
      });

      test("without trailing zeros", () => {
        expect(format.commas.digits(6).of(number)).toEqual("12,345.678900");
        expect(format.commas.digits(6).trailingZero(false).of(number)).toEqual("12,345.6789");
        expect(format.commas.digits(6).trailingZero(true).of(number)).toEqual("12,345.678900");
      });
      ...
      test("with a default value", () => {
        expect(format.commas.default("default").of(undefined)).toEqual("default");
    ...
    describe("should properly format bigint in commas format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.commas.unit("ETH").sign().of(bigint, decimals)).toEqual("+12,345.6789 ETH");
        expect(format.commas.unit("ETH").sign().of(-bigint, decimals)).toEqual("-12,345.6789 ETH");
      });
      ...
      test("with a default value", () => {
        expect(format.commas.default("default").of(undefined, 18)).toEqual("default");
        expect(format.commas.default("default").of(null, 18)).toEqual("default");
        expect(format.commas.default("default").of(bigint, undefined)).toEqual("default");
        expect(format.commas.default("default").of(bigint, null)).toEqual("default");
      });
  ...
  describe("percent", () => {
    describe("should properly format number in percent format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.percent.unit("%").sign().of(number)).toEqual("+1234567.8900%");
        expect(format.percent.unit("%").sign().of(-number)).toEqual("-1234567.8900%");
      });

      test("without trailing zeros", () => {
        expect(format.percent.digits(6).trailingZero(false).of(number)).toEqual("1234567.89");
      });
      ...
      test("with a default value", () => {
        expect(format.percent.default("default").of(undefined)).toEqual("default");
    ...
    describe("should properly format bigint in percent format", () => {
      ...
      test("with unit with sign", () => {
        expect(format.percent.unit("%").sign().of(bigint, decimals)).toEqual("+1234567.8900%");
        expect(format.percent.unit("%").sign().of(-bigint, decimals)).toEqual("-1234567.8900%");
      });
      ...
      test("with a default value", () => {
        expect(format.percent.default("default").of(undefined, 18)).toEqual("default");
        expect(format.percent.default("default").of(null, 18)).toEqual("default");
        expect(format.percent.default("default").of(bigint, undefined)).toEqual("default");
        expect(format.percent.default("default").of(bigint, null)).toEqual("default");
      });
...
describe("formatLongString", () => {
  test("returns the string unchanged when maxLength is not provided", () => {
    expect(formatLongString("hello world")).toBe("hello world");
  });

  test("returns the string unchanged when maxLength >= string length", () => {
    expect(formatLongString("hello", 10)).toBe("hello");
    expect(formatLongString("hello", 5)).toBe("hello");
  });

  test("returns '...' when maxLength <= 3", () => {
    expect(formatLongString("hello world", 3)).toBe("...");
    expect(formatLongString("hello world", 2)).toBe("...");
    expect(formatLongString("hello world", 1)).toBe("...");
  });

  test("truncates with one leading char when maxLength is 4", () => {
    expect(formatLongString("hello world", 4)).toBe("h...");
  });

  test("truncates long string with leading and trailing chars", () => {
    // maxLength=10, nChar=7, leading=round(7/2)=4, trailing=floor(7/2)=3
    // "abcdefghijklmnop".slice(0,4) = "abcd", slice(-3) = "nop"
    expect(formatLongString("abcdefghijklmnop", 10)).toBe("abcd...nop");
  });

  test("handles empty string", () => {
    // maxLength >= str.length (0 >= 0) so returns unchanged
...
describe("formatUnion", () => {
  ...
  test("returns single item as-is", () => {
    expect(formatUnion(["apple"])).toBe("apple");
  });

  test("joins two items with 'or'", () => {
    expect(formatUnion(["apple", "banana"])).toBe("apple or banana");
  });

  test("joins three or more items with commas and 'or' before last", () => {
...
describe("formatEnumeration", () => {
  ...
  test("returns single item as-is", () => {
    expect(formatEnumeration(["apple"])).toBe("apple");
  });

  test("joins two items with 'and'", () => {
    expect(formatEnumeration(["apple", "banana"])).toBe("apple and banana");
  });

  test("joins three or more items with commas and 'and' before last", () => {
